        ...
        <div id="rev_slider_1" class="rev_slider">
            <ul>
                <li data-index="rs-1706" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <img src="{{ asset('assets/images/banner/banner_1.jpg') }}" alt="Sky" class="rev-slidebg"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    <!-- LAYER NR. 1 -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                <div class="latest_blog_carousel">
                     <div class="single_item single_item_first">
                        <div class="blog-img">
                            <a href="#"><img src="{{ asset('assets/images/features/features_1.jpg') }}" alt="" class="img-fluid"></a>
                        </div>
                    ...
                    <div class="single_item single_item_center">
                        <div class="blog-img">
                            <a href="#" title=""><img src="{{ asset('assets/images/features/features_2.jpg') }}" alt="" class="img-fluid"></a>
                        </div>
                        <div class="blog_title">
                            <span>Go To</span>  
    ...
    <div class="container"> 
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    <div class="courses_banner_wrapper">
                        <div class="courses_banner"><a href="#"><img src="{{ asset('assets/images/courses/courses_1.jpg') }}" alt="" class="img-fluid"></a></div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    <div class="courses_banner_wrapper">
                        <div class="courses_banner"><a href="#"><img src="{{ asset('assets/images/courses/courses_2.jpg') }}" alt="" class="img-fluid"></a></div>
                        <div class="purchase_price">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    <div class="courses_banner_wrapper">
                        <div class="courses_banner"><a href="#"><img src="{{ asset('assets/images/courses/courses_3.jpg') }}" alt="" class="img-fluid"></a></div>
                        <div class="purchase_price">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    <div class="courses_banner_wrapper">
                        <div class="courses_banner"><a href="#"><img src="{{ asset('assets/images/courses/courses_4.jpg') }}" alt="" class="img-fluid"></a></div>
                        <div class="purchase_price">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    <div class="courses_banner_wrapper">
                        <div class="courses_banner"><a href="#"><img src="{{ asset('assets/images/courses/courses_5.jpg') }}" alt="" class="img-fluid"></a></div>
                        <div class="purchase_price">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                <div class="single-courses">
                    <div class="courses_banner_wrapper">
                        <div class="courses_banner"><a href="#"><img src="{{ asset('assets/images/courses/courses_6.jpg') }}" alt="" class="img-fluid"></a></div>
                        <div class="purchase_price">
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-7 ml-auto p-0">
                <div class="banner_learn">
                    <img src="{{ asset('assets/banner/learnstep.jpg') }}" alt="" class="img-fluid">
                 </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-7 col-lg-7">
                    <div class="story_banner">
                        <img src="{{ asset('assets/images/banner/about_us.png') }}" alt="" class="img-fluid">
                     </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 events_full_box">
                <div class="events_single">
                    <div class="event_banner">
                        <a href="#"><img src="{{ asset('assets/images/events/event_1.jpg') }}" alt="" class="img-fluid"></a>
                    </div>
            ...
            <div class="col-sm-12 events_full_box">
                <div class="events_single events_single_left">
                    ...
                    <div class="event_banner">
                        <a href="#"><img src="{{ asset('assets/images/events/event_2.jpg') }}" alt="" class="img-fluid"></a>
                    </div>
                    <div class="event_dete">
            ...
            <div class="col-sm-12 events_full_box">
                <div class="events_single">
                    <div class="event_banner">
                        <a href="#"><img src="{{ asset('assets/images/events/event_3.jpg') }}" alt="" class="img-fluid"></a>
                    </div>
                    <div class="event_info">
                    ...
                    <div class="reviewer_info">
                        <div class="carousel_images slider-nav">
                            <div class="restimonial_single_img">
                                <img src="{{ asset('assets/images/team/review_1.jpg') }}" alt="2" class="img-fluid">
                            ...
                            <div class="restimonial_single_img">
                                <img src="{{ asset('assets/images/team/review_4.jpg') }}" alt="2" class="img-fluid ">
                                <div class="name_position">
                            ...
                            <div class="restimonial_single_img ">
                                <img src="{{ asset('assets/images/team/review_3.jpg') }}" alt="2" class="img-fluid">
                                <div class="name_position">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                 <div class="single_item single_item_first">
                    <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('assets/images/blog/blog_1.jpg') }}" alt="" class="img-fluid"></a>
                    </div>
                    <div class="blog_title">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                <div class="single_item single_item_center">
                     <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('assets/images/blog/blog_2.jpg') }}" alt="" class="img-fluid"></a>
                    </div>
                    <div class="blog_title">
                        <span>LeaderShip Development</span>  
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
               <div class="single_item single_item_last">
                     <div class="blog-img">
                        <a href="#" title=""><img src="{{ asset('assets/images/blog/blog_3.jpg') }}" alt="" class="img-fluid"></a>
                    </div>
                    <div class="blog_title">
                        <span>LeaderShip Development</span>  
                        <h3><a href="#" title="">How to Become Master In <br>CSS within qa Week.</a></h3> 
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                <ul class="sponsored_company_logos">
                    <li><img src="{{ asset('assets/images/logos/logo-1.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".1s"></li>
                    <li><img src="{{ asset('assets/images/logos/logo-2.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".2s"></li>
                    <li><img src="{{ asset('assets/images/logos/logo-3.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".3s"></li>
                    <li><img src="{{ asset('assets/images/logos/logo-4.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".6s"></li>
                    <li><img src="{{ asset('assets/images/logos/logo-5.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".5s"></li>
                </ul>
                <ul class="sponsored_company_logos sponsored_company_logos_2">
                    <li><img src="{{ asset('assets/images/logos/logo-6.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".4s"></li>
                    <li><img src="{{ asset('assets/images/logos/logo-7.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".3s"></li>
                    <li><img src="{{ asset('assets/images/logos/logo-8.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".6s"></li>
                    <li><img src="{{ asset('assets/images/logos/logo-9.png') }}" alt="" class="img-fluid  wow fadeIn" data-wow-duration="2s" data-wow-delay=".5s"></li>
                </ul>
            </div>            
        </div>
    </div>
